...
test("all migrations apply to an empty SQLite database", () => {
  ...
  for (const requiredIndex of [
    ...
    "auth_credentials_login_uidx",
    "auth_events_principal_time_idx",
    "auth_sessions_principal_expiry_idx",
    ...
    "message_attachments_conversation_status_idx",
    "message_attachments_message_idx",
    "message_attachments_object_key_uidx",
  ...
  assert.deepEqual(triggers, [
    ...
    "auth_credentials_identity_immutable",
    "auth_credentials_prevent_delete",
    "auth_credentials_single_owner",
    "auth_events_prevent_delete",
    "auth_events_prevent_update",
    ...
    "message_attachments_prevent_attached_delete",
    "message_attachments_restrict_update",
    "message_attachments_validate_insert",
    "messages_prevent_delete",
    "messages_prevent_update",
    "messages_validate_attachment_envelope",
